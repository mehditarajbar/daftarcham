...
<button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"  class="bg-[#f5f5f5] px-2 py-2 mr-2 rounded-3xl hover:cursor-pointer relative" type="button"> 
  ...
  <div class="absolute inline-flex w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-7 -right-1 dark:border-gray-900"></div>
</div>
</button>
<!-- Dropdown menu -->
<div id="dropdownNotification" class="z-20 hidden w-full custom-transfer-notification  max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
  ...
  <div class="divide-y divide-gray-100 dark:divide-gray-700">
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="../assets/notif-prof/profile-picture-1.jpg" alt="Jese image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="../assets/notif-prof/profile-picture-2.jpg" alt="Joseph image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="../assets/notif-prof/profile-picture-3.jpg" alt="Bonnie image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="../assets/notif-prof/profile-picture-4.jpg" alt="Leslie image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="../assets/notif-prof/profile-picture-5.jpg" alt="Robert image">
