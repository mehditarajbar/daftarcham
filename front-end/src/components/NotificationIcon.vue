...
<template>
  <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
    class="bg-[#f5f5f5] px-2 py-2 mr-2 rounded-3xl hover:cursor-pointer relative" type="button">
    ...
    <div class="relative flex">
      <div
        class="absolute inline-flex w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-7 -right-1 dark:border-gray-900">
      </div>
    </div>
  </button>
  <!-- Dropdown menu -->
  <div id="dropdownNotification"
    class="z-20 hidden w-full custom-transfer-notification  max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700"
  ...
  <a href="#"
    ...
    <div class="inline-flex items-center ">
      <svg class="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
