...
<button id="dropdownMessageButton" data-dropdown-toggle="dropdownMessage"  class="bg-[#f5f5f5] px-2 py-2 mr-2 rounded-3xl hover:cursor-pointer relative" type="button"> 
...
<!-- Dropdown menu -->
<div id="dropdownMessage" class="z-20 hidden w-full custom-transfer-message  max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
